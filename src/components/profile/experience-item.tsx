...
export function ExperienceItem({
  ...
  return (
    <Collapsible
      defaultOpen={isOpen === undefined ? experience.isExpanded : undefined}
      open={isOpen}
    ...
    >
      ...
      >
        <div className="flex items-center">
          ...
          <div className="border-edge flex-1 border-l border-dotted">
            <CollapsibleTrigger
              className={cn(
        ...
        <CollapsibleContent className="data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down overflow-hidden duration-300">
          <div className="border-edge space-y-4 border-t border-dotted p-4">
